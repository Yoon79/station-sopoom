    ...
    <div className="bg-amber-50">
      ...
      <div className=" justify-center  max-w-2xl mx-auto py-10 px-8 grid items-center grid-cols-1 gap-y-4 gap-x-10 sm:px-8 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
        ...
        <div className="lg:ml-[380px]  xl:ml-[460px]  2xl:ml-[600px]">
          <div className="py-3 text-gray-800 font-bold text-xl">캣인더박스 (가제)</div>
          <div className="text-gray-700 font-medium text-l">cat in the box</div>
        </div>
        <div className="flex-col pt-20 py-6">
          ...
          <a href="https://www.instagram.com/131300_studio/" target="__blank">
